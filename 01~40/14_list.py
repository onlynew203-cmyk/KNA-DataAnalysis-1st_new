...
age = [37, 38, 39, 40]
age.append(88)
print(age) # [37, 38, 39, 40, 88]

# ---------------------------
# insert()로 원하는 위치에 값 추가하기
abc = [37, 38, 39, 40]
abc.insert(0, 10)
print(abc) # [10, 37, 38, 39, 40] 출력
...
left.extend(right)
print(left) # [1, 2, 3, 0, 0, 0] 출력

# ---------------------------
# .remove(값) 값 제거
all = [37, 38, 39, 40]
all.remove(40)
print(all) # [37, 38, 39] 출력

# .pop(인덱스) 위치로 꺼내며 값 제거
all = [3,4,5,6]
all.pop(3) # [3] 위치 값 pop
print(all) # [3,4,5] 출력
...
# .sort() 정렬하기
# 리스트 정렬하기
# 데이터를 정렬 - 기본적으로 오름차순 ! 작은 숫자부터 큰 숫자까지
# 내림차순으로 하고 싶다면, .sort(reverse=True)

temps = [23, 52, 12, 19, 28, 93, 83, -1, 99, 8]
temps.sort()
print(temps) # [-1, 8, 12, 19, 23, 28, 52, 83, 93, 99]  출력

temps.sort(reverse=True)
print(temps) # [99, 93, 83, 52, 28, 23, 19, 12, 8, -1] 출력

# ------------------------------------------------------------------------------------
# reverse() 순서 뒤집기
temps = [23, 52, 12, 19, 28, 93, 83, -1, 99, 8]
temps.reverse()
print(temps) # [8, 99, -1, 83, 93, 28, 19, 12, 52, 23] 출력
...
print(results.count(1)) # 3 -> 1은 3개
print(results.count(0)) # 5 -> 0은 5개
print(results.index(0)) # 0 -> 0은 0번째에
print(results.index(1)) # 1 -> 1은 1번째에

# ---------------------------
# 실습 정렬하고 탐색하기
temps = [23, 52, 12, 19, 28, 93, 83, -1, 99, 8]
temps.sort()
print(temps) # [-1, 8, 12, 19, 23, 28, 52, 83, 93, 99] 오름차순 정렬
temps.reverse()
print(temps) # [99, 93, 83, 52, 28, 23, 19, 12, 8, -1] 뒤집에서 출력
print(temps.count(99)) # 1 출력 -> 99의 갯수는 1
print(temps.index(99)) # 0 출력 -> 99의 위치는 0
