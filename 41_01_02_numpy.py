...
# MacBook-Pro:KNA-DataAnalysis-1st_new jeongonyu$ pip3 search numpy
...
# 그 안에 개별 프로젝트가 사용할 pip 라이브러리들을 따로 받아 쓰게 된다
# 이것이 바로 가상환경(venv)
...
# (이후에는 가상환경 안에서 터미널 명령 실행 가능, 예 pip3 install numpy)
...
print(np_numbers)
# print(type(np_numbers)) # <class 'numpy.ndarray'>
